...
mainScene.changeColor = function() {
    // 背景色を変更
    var randomNumber = Phaser.Math.RND.between(1, 4);
    if (randomNumber == 1) {
        this.cameras.main.setBackgroundColor('#135791');
        
    } else if (randomNumber == 2) {
        this.cameras.main.setBackgroundColor('#00ff00');
        
    } else if (randomNumber == 3) {
        this.cameras.main.setBackgroundColor('#fff000');
...
mainScene.createBlocks = function() {
    // 横10列、縦6行並べる
    //ブロックの色の配列
    var blockColors = ["silver2","silver2","silver2","silver2","silver2","silver2","silver2","silver2"];
