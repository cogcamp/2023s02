...
mainScene.config = function() {
    // 背景色の設定
    this.cameras.main.setBackgroundColor('#7CA1F0');
...
mainScene.createBlocks = function() {
    // 横10列、縦8行並べる
    // ブロックの色の配列
    var blockColors = [ 'yellow1','yellow2','purple1','purple2','blue1','blue2','green1','green2'];
    ...
    for( var i = 0; i < 8; i++){
        ...
        for( var j = 0; j < 12; j++){
            ...
            var block = this.blocks.create(20 + j * 64, 80 + i * 32,color);
            block.setOrigin(0,0);
